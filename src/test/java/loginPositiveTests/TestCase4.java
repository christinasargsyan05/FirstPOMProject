...
public class TestCase4 {
    public static void main(String[] args) {
        ...
        signUpPageAndLoginPage.clickOnAndEnterTheLoginEmail("leonovaania@upoea.com");

        signUpPageAndLoginPage.clickOnAndEnterTheLoginPassword("1234");
        ...
        userPersonalPage.clickOnLogoutButton();
